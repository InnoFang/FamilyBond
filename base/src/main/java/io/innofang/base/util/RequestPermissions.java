...
public class RequestPermissions {
    ...
    public static void requestRuntimePermission(String[] permissions, OnRequestPermissionsListener listener) {
        requestRuntimePermission(ActivityCollector.getTopActivity(), permissions, listener);
    }
